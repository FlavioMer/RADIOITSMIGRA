...
export default function StationInfo() {
    //Definimos dos funciones para abrir el link de la pagina web
    //y el telefono de la estación
  const handleWebsitePress = () => { // Abre el sitio web de la estación
    Linking.openURL(RADIO_CONFIG.station.website);
  };

  const handleCallPress = () => { //Abre el telefono
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Image 
          ...
          style={styles.logo}
          resizeMode="contain"//  escala la imagen para que quepa completamente dentro del área sin distorsionarla
        />
      ...
      <View style={styles.contactContainer}>
        ...
        <TouchableOpacity style={styles.contactButton} onPress={handleCallPress}>
          <Ionicons name="call" size={16} color={RADIO_CONFIG.colors.text} />
